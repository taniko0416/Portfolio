...
ActiveRecord::Schema.define(version: 2020_01_19_070311) do

  create_table "likes", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
